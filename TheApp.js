...
export default class TheApp extends Document {
    constructor() {
    ...
    connectedCallback() {
        ...
        const comps = document.querySelectorAll('[is^="a-"]');

        comps.forEach((comp)=>{

            let cnames = comp.getAttribute('is').split('-');

            let jsName = cnames.map((nm, i)=>{
                if(i == 0)
...
customElements.define('the-app', TheApp, {extends : 'html'});